...
$('#proyecto').on('change', function(e) {
    ...
    $('#char-complete').load($pathname+' #body-complete');
    $('#char-task').load($pathname+' #body-task');
    ...
    // -- Pie Chart Example
            ...
            var myPieChart = new Chart(ctx, {
              type: 'pie',
              data: {
                labels: ["Completado", "Por completar", "En proceso"],
                datasets: [{
                  data: [response.task_count_terminado, response.task_count_total, response.task_count_proceso],
